...
sys.path.append('../')
sys.path.append('./')
from ner_task.utils import MODEL_CLASSES, MODEL_PATH_MAP, init_logger
from ner_task.trainer import Trainer
from ner_task.load_data import load_and_cache_examples
